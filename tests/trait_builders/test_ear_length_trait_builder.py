...
class TestEarLengthTraitBuilder(unittest.TestCase):
    ...
    def test_parse_03(self):
        self.assertEqual(
            ...
            [Trait(value=25.4, units='"', ambiguous_key=True,
                   start=22, end=26)])
    ...
    def test_parse_04(self):
        self.assertEqual(
            PAR.parse('{"measurements":"TotalLength=180 Tail=82 '
                      'HindFoot=28 Ear=18" }'),
            [Trait(value=18, units_inferred=True, start=53, end=59)])

    def test_parse_05(self):
        self.assertEqual(
            PAR.parse('{"earLength":"13", "gonadLength":"3"}'),
            [Trait(value=13, units_inferred=True,
                   start=2, end=16)])
    ...
    def test_parse_09(self):
        self.assertEqual(
            ...
            [Trait(value=17, units='mm', measured_from='notch',
                   start=0, end=20)])

    def test_parse_10(self):
        self.assertEqual(
            PAR.parse('earfromcrown=17mm;'),
            [Trait(value=17, units='mm', measured_from='crown',
                   start=0, end=17)])

    def test_parse_11(self):
        self.assertEqual(
            PAR.parse('{"measurements":"242-109-37-34=N/D" }'),
            [Trait(value=34, units='mm_shorthand', is_shorthand=True,
                   start=2, end=34)])

    def test_parse_12(self):
        self.assertEqual(
            PAR.parse('E/n-21mm'),
            [Trait(value=21, units='mm', ambiguous_key=True,
    ...
    def test_parse_14(self):
        self.assertEqual(
            ...
            [Trait(value=6.35, units='in', measured_from='notch',
                   start=2, end=23)])
    ...
    def test_parse_17(self):
        self.assertEqual(
            ...
            [Trait(value=13, measured_from='n', units_inferred=True,
                   start=14, end=21)])
