...
from pylib.trait_builders.testes_size_trait_builder \
    import TestesSizeTraitBuilder


class TestTestesSizeTraitBuilder(unittest.TestCase):

    parser = TestesSizeTraitBuilder()

    def test_parse_01(self):
        self.assertEqual(
            self.parser.parse('testes = 8x5 mm'),
            [NumericTrait(
    ...
    def test_parse_02(self):
        self.assertEqual(
            self.parser.parse('testes: 20mm. Sent to Berkeley 10/1/71'),
            [NumericTrait(
    ...
    def test_parse_06(self):
        self.assertEqual(
            self.parser.parse('Plus Tissue; plus Baculum: Test 21x11'),
            [NumericTrait(
    ...
    def test_parse_08(self):
        self.assertEqual(
            self.parser.parse('Scrotal 9 mm x 5 mm'),
            [NumericTrait(value=[9, 5], units_inferred=False,
    ...
    def test_parse_11(self):
        self.assertEqual(
            self.parser.parse('Testes x6'),
            [NumericTrait(
                value=6, units=None, units_inferred=True, start=0, end=9)])

    def test_parse_12(self):
        self.assertEqual(
            self.parser.parse('testes scrotal, L testis 13x5mm'),
            [NumericTrait(
    ...
    def test_parse_14(self):
        self.assertEqual(
            self.parser.parse('"gonadLengthInMM":"12", "gonadWidthInMM":"5",'),
            [NumericTrait(
    ...
    def test_parse_16(self):
        self.assertEqual(
            self.parser.parse('"gonadLengthInMM":"9mm w.o./epid", '),
            [NumericTrait(
    ...
    def test_parse_17(self):
        self.assertEqual(
            self.parser.parse('testis-7mm'),
            [NumericTrait(
                value=7, units='mm', units_inferred=False, start=0, end=10)])

    def test_parse_18(self):
        self.assertEqual(
            self.parser.parse('reproductive data=T=10x4 ; '),
            [NumericTrait(
    ...
    def test_parse_20(self):
        self.assertEqual(
            self.parser.parse('adult ; T=9x4 ; endoparasite '),
            [NumericTrait(
    ...
    def test_parse_21(self):
        self.assertEqual(
            self.parser.parse('adult ; T=9 ; endoparasite '),
            [])

    def test_parse_22(self):
        self.assertEqual(
            self.parser.parse('TESTES 5-3.5 MM,'),
            [NumericTrait(
    ...
    def test_parse_23(self):
        self.assertEqual(
            self.parser.parse('reproductive data=T: R-2x4mm ; '),
            [NumericTrait(
    ...
    def test_parse_24(self):
        self.assertEqual(
            self.parser.parse('reproductive data=T: L-2x4mm ; '),
            [NumericTrait(
    ...
    def test_parse_25(self):
        self.assertEqual(
            self.parser.parse('testes (R) 6 x 1.5 & 5 x 2 mm'),
            [NumericTrait(
    ...
    def test_parse_27(self):
        self.assertEqual(
            self.parser.parse('; reproductive data=5x3 inguinal ;'),
            [NumericTrait(
    ...
    def test_parse_31(self):
        self.assertEqual(
            self.parser.parse('reproductive data=Right testicle: 20x9 mm ;'),
            [NumericTrait(
    ...
    def test_parse_32(self):
        self.assertEqual(
            self.parser.parse('; reproductive data=Testes scrotal, 32x11'),
            [NumericTrait(
    ...
    def test_parse_34(self):
        self.assertEqual(
            self.parser.parse('; reproductive data=R 20mm L 6 mm ;'),
            [NumericTrait(
                value=20, units='mm', units_inferred=False, side='r',
                start=2, end=33),
             NumericTrait(
    ...
    def test_parse_35(self):
        self.assertEqual(
            self.parser.parse('; reproductive data=(R) 20x10mm L 6x4 mm ;'),
            [NumericTrait(
    ...
    def test_parse_36(self):
        self.assertEqual(
            self.parser.parse('; reproductive data=R 20x10mm ;'),
            [NumericTrait(
                value=[20, 10], units='mm', units_inferred=False, side='r',
                start=2, end=29)])
    ...
    def test_parse_37(self):
        self.assertEqual(
            self.parser.parse('; reproductive data=t=233mg ;'),
            [])
