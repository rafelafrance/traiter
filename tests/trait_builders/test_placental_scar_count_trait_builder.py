...
class TestPlacentalScarCountTraitBuilder(unittest.TestCase):
    ...
    def test_parse_32(self):
        self.assertEqual(
            self.parser.parse('no visible placental scarring'),
            [NumericTrait(value=0, start=0, end=29)])

    def test_parse_33(self):
        self.assertEqual(
            self.parser.parse('; 1 scar on tail ;'),
            [])
    ...
    def test_parse_38(self):
        self.assertEqual(
            self.parser.parse('ut horns: R 1 definite scar, L 2+ scars;'),
            [NumericTrait(value=3, left=2, right=1, start=10, end=39)])

    def test_parse_39(self):
        self.assertEqual(
            self.parser.parse('DINO 14431; placental scars'),
    ...
    def test_parse_41(self):
        self.assertEqual(
            self.parser.parse('5 ut scars, 132-62-20-15=19'),
    ...
    def test_parse_43(self):
        self.assertEqual(
            self.parser.parse('Zion 11396; NK 36683; scars/no embs/lact'),
    ...
    def test_parse_46(self):
        self.assertEqual(
            self.parser.parse('H,K,L,L,S; UTERINE SCARS=2R'),
            [NumericTrait(value=2, right=2, start=11, end=27)])

    def test_parse_47(self):
        self.assertEqual(
            self.parser.parse('no embryonic scars 360-40-125-68 1800g'),
            [NumericTrait(value=0, start=0, end=18)])
