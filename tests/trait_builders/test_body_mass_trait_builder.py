...
class TestBodyMassTraitBuilder(unittest.TestCase):
    ...
    parser = BodyMassTraitBuilder()

    def test_parse_01(self):
        self.assertEqual(
            self.parser.parse('762-292-121-76 2435.0g'),
    ...
    def test_parse_04(self):
        self.assertEqual(
            self.parser.parse('body mass=20 g'),
            [NumericTrait(
                value=20, units='g', units_inferred=False, start=0, end=14)])

    def test_parse_05(self):
        self.assertEqual(
            self.parser.parse('2 lbs. 3.1 - 4.5 oz '),
            [NumericTrait(
    ...
    def test_parse_08(self):
        self.assertEqual(
            self.parser.parse('Note in catalog: 83-0-17-23-fa64-35g'),
            [NumericTrait(
    ...
    def test_parse_09(self):
        self.assertEqual(
            self.parser.parse('{"measurements":"20.2g, SVL 89.13mm" }'),
            [NumericTrait(
                value=20.2, units='g', units_inferred=False, start=2, end=22)])

    def test_parse_10(self):
        self.assertEqual(
            self.parser.parse('Body: 15 g'),
            [NumericTrait(
                value=15, units='g', units_inferred=False, start=0, end=10)])

    def test_parse_11(self):
        self.assertEqual(
            self.parser.parse('82-00-15-21-tr7-fa63-41g'),
            [NumericTrait(
    ...
    def test_parse_15(self):
        self.assertEqual(
            self.parser.parse('{"measurements":"143-63-20-17=13 g" }'),
            [NumericTrait(
    ...
    def test_parse_18(self):
        self.assertEqual(
            self.parser.parse('{ "massingrams"="20.1" }'),
            [NumericTrait(
    ...
    def test_parse_23(self):
        self.assertEqual(
            self.parser.parse('"weight: 21-32'),
    ...
    def test_parse_35(self):
        self.assertEqual(
            self.parser.parse('; weight = [50.8] g ;'),
            [NumericTrait(
    ...
    def test_parse_36(self):
        self.assertEqual(
            self.parser.parse('{"measurements":"242-109-37-34=N/D" }'),
            [])
    ...
    def test_parse_38(self):
        self.assertEqual(
            self.parser.parse('; weight=22 oz; Verbatim weight=1lb 6oz;'),
            [
                NumericTrait(
    ...
    def test_parse_39(self):
        self.assertEqual(
            self.parser.parse('bacu wt=0.09'),
            [])

    def test_parse_40(self):
        self.assertEqual(
            self.parser.parse('femur wt=1.05'),
            [])
    ...
    def test_parse_44(self):
        self.assertEqual(
            self.parser.parse('Weight=22 lbs., 7 oz.; Length=41 in. T.L.'),
            [NumericTrait(
    ...
    def test_parse_45(self):
        self.assertEqual(
            self.parser.parse('{"earLengthInmm":"X", "weightInlbs":"22"}'),
            [NumericTrait(
    ...
    def test_parse_46(self):
        self.assertEqual(
            self.parser.parse('{"measurements":"90-30-16-7=6.9MGS" }'),
            [NumericTrait(
    ...
    def test_parse_47(self):
        self.assertEqual(
            self.parser.parse('; unformatted measurements=g 0.24 mm ;'),
            [])
