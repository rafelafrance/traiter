...
from traiter.trait_builders.body_mass_trait_builder \
...
class TestBodyMassTraitBuilder(unittest.TestCase):
    ...
    def test_parse_01(self):
        self.assertEqual(
            ...
            [NumericTrait(value=2435, units='g', is_shorthand=True,
                          start=0, end=22)])

    def test_parse_02(self):
        self.assertEqual(
            PAR.parse('TL (mm) 44,SL (mm) 38,Weight (g) 0.77 xx'),
            [NumericTrait(value=0.77, units='g', start=22, end=37)])

    def test_parse_03(self):
        self.assertEqual(
            PAR.parse(
                'Note in catalog: Mus. SW Biol. NK 30009; 91-0-17-22-62g'),
            [NumericTrait(value=62, units='g', is_shorthand=True,
                          start=41, end=55)])

    def test_parse_04(self):
        self.assertEqual(
            PAR.parse('body mass=20 g'),
            [NumericTrait(value=20, units='g', start=0, end=14)])
    ...
    def test_parse_06(self):
        self.assertEqual(
            PAR.parse('{"totalLengthInMM":"x", "earLengthInMM":"20", '
                      '"weight":"[139.5] g" }'),
            [NumericTrait(
                value=139.5, units='g', estimated_value=True,
                start=47, end=65)])
    ...
    def test_parse_07(self):
        self.assertEqual(
            ...
            [NumericTrait(value=94, units='gr', start=101, end=115)])

    def test_parse_08(self):
        self.assertEqual(
            PAR.parse('Note in catalog: 83-0-17-23-fa64-35g'),
            [NumericTrait(value=35, units='g', is_shorthand=True,
                          start=8, end=36)])

    def test_parse_09(self):
        self.assertEqual(
            PAR.parse('{"measurements":"20.2g, SVL 89.13mm" }'),
            [NumericTrait(value=20.2, units='g', start=2, end=22)])

    def test_parse_10(self):
        self.assertEqual(
            PAR.parse('Body: 15 g'),
            [NumericTrait(value=15, units='g', start=0, end=10)])

    def test_parse_11(self):
        self.assertEqual(
            PAR.parse('82-00-15-21-tr7-fa63-41g'),
            [NumericTrait(value=41, units='g', is_shorthand=True,
                          start=0, end=24)])

    def test_parse_12(self):
        self.assertEqual(
            PAR.parse('weight=5.4 g; unformatted measurements=77-30-7-12=5.4'),
            [NumericTrait(value=5.4, units='g', start=0, end=12),
             NumericTrait(
                value=5.4, units_inferred=True, is_shorthand=True,
                start=26, end=53)])
    ...
    def test_parse_13(self):
        self.assertEqual(
            ...
            [NumericTrait(
                ...
                start=12, end=39),
             NumericTrait(
                value=5.4, units_inferred=True, start=41, end=51)])

    def test_parse_14(self):
        self.assertEqual(
            PAR.parse('{"totalLengthInMM":"270-165-18-22-31", '),
            [NumericTrait(
                value=31, units_inferred=True, is_shorthand=True,
                start=20, end=36)])
    ...
    def test_parse_15(self):
        self.assertEqual(
            ...
            [NumericTrait(
                value=13, units='g', is_shorthand=True, start=2, end=34)])

    def test_parse_16(self):
        self.assertEqual(
            PAR.parse('143-63-20-17=13'),
            [NumericTrait(
                value=13, units_inferred=True, is_shorthand=True,
                start=0, end=15)])
    ...
    def test_parse_17(self):
        self.assertEqual(
            ...
            [NumericTrait(
                value=22, units='g', is_shorthand=True, start=69, end=100)])

    def test_parse_18(self):
        self.assertEqual(
            PAR.parse('{ "massingrams"="20.1" }'),
            [NumericTrait(value=20.1, units='grams', start=3, end=21)])
    ...
    def test_parse_19(self):
        self.assertEqual(
            PAR.parse(' {"gonadLengthInMM_1":"10", "gonadLengthInMM_2":"6", '
                      '"weight":"1,192.0" }'),
            [NumericTrait(
                value=1192, units_inferred=True, start=54, end=70)])

    def test_parse_20(self):
        self.assertEqual(
            PAR.parse('"weight: 20.5-31.8'),
            [NumericTrait(value=[20.5, 31.8], units_inferred=True,
                          start=1, end=18)])

    def test_parse_21(self):
        self.assertEqual(
            PAR.parse('"weight: 20.5-32'),
            [NumericTrait(value=[20.5, 32], units_inferred=True,
                          start=1, end=16)])
    ...
    def test_parse_22(self):
        self.assertEqual(
            ...
            [NumericTrait(
                value=[21, 31.8], units_inferred=True, start=1, end=16)])

    def test_parse_23(self):
        self.assertEqual(
            PAR.parse('"weight: 21-32'),
            [NumericTrait(value=[21, 32], units_inferred=True,
                          start=1, end=14)])
    ...
    def test_parse_25(self):
        self.assertEqual(
            ...
            [NumericTrait(value=5.4, units='g', start=0, end=12),
             NumericTrait(value=5.4, units_inferred=True, is_shorthand=True,
                          start=26, end=52)])
    ...
    def test_parse_27(self):
        self.assertEqual(
            ...
            [NumericTrait(value=0, units='g', start=0, end=13)])
    ...
    def test_parse_31(self):
        self.assertEqual(
            ...
            [NumericTrait(value=62, estimated_value=True, units_inferred=True,
                          is_shorthand=True, start=41, end=56)])

    def test_parse_32(self):
        self.assertEqual(
            PAR.parse('wt=10 g'),
            [NumericTrait(value=10, units='g', start=0, end=7)])

    def test_parse_33(self):
        self.assertEqual(
            PAR.parse('w.t.=10 g'),
            [NumericTrait(value=10, units='g', start=0, end=9)])
    ...
    def test_parse_35(self):
        self.assertEqual(
            ...
            [NumericTrait(value=50.8, units='g', estimated_value=True,
                          start=2, end=19)])
    ...
    def test_parse_37(self):
        self.assertEqual(
            ...
            [NumericTrait(value=650, units='kg', start=21, end=34)])

    def test_parse_38(self):
        self.assertEqual(
            PAR.parse('; weight=22 oz; Verbatim weight=1lb 6oz;'),
            [NumericTrait(value=623.69, units='oz', start=2, end=14),
             NumericTrait(
                value=623.69, units=['lbs', 'ozs'], start=25, end=39)])
    ...
    def test_parse_44(self):
        self.assertEqual(
            ...
            [NumericTrait(
                value=10177.48, units=['lbs', 'ozs'], start=0, end=20)])

    def test_parse_45(self):
        self.assertEqual(
            PAR.parse('{"earLengthInmm":"X", "weightInlbs":"22"}'),
            [NumericTrait(value=9979.03, units='lbs', start=23, end=39)])

    def test_parse_46(self):
        self.assertEqual(
            PAR.parse('{"measurements":"90-30-16-7=6.9MGS" }'),
            [NumericTrait(
                value=0.01, units='mgs', is_shorthand=True, start=2, end=34)])
