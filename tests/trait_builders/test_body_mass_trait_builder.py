...
class TestBodyMassTraitBuilder(unittest.TestCase):
    ...
    def test_parse_01(self):
        self.assertEqual(
            ...
            [Trait(value=2435, units='g', is_shorthand=True,
                   start=0, end=22)])
    ...
    def test_parse_03(self):
        self.assertEqual(
            ...
            [Trait(value=62, units='g', is_shorthand=True, start=41, end=55)])
    ...
    def test_parse_06(self):
        self.assertEqual(
            PAR.parse('{"totalLengthInMM":"x", "earLengthInMM":"20", '
                      '"weight":"[139.5] g" }'),
            [Trait(value=139.5, units='g', estimated_value=True,
                   start=47, end=65)])
    ...
    def test_parse_08(self):
        self.assertEqual(
            ...
            [Trait(value=35, units='g', is_shorthand=True,
                   start=8, end=36)])
    ...
    def test_parse_12(self):
        self.assertEqual(
            ...
            [Trait(value=5.4, units='g', start=0, end=12),
             Trait(value=5.4, units_inferred=True, is_shorthand=True,
                   start=26, end=53)])
    ...
    def test_parse_13(self):
        self.assertEqual(
            ...
            [Trait(value=5.4, units_inferred=True, is_shorthand=True,
                   start=12, end=39),
             Trait(value=5.4, units_inferred=True,
                   start=41, end=51)])

    def test_parse_14(self):
        self.assertEqual(
            PAR.parse('{"totalLengthInMM":"270-165-18-22-31", '),
            [Trait(value=31, units_inferred=True, is_shorthand=True,
                   start=20, end=36)])

    def test_parse_15(self):
        self.assertEqual(
            PAR.parse('{"measurements":"143-63-20-17=13 g" }'),
            [Trait(value=13, units='g', is_shorthand=True, start=2, end=34)])

    def test_parse_16(self):
        self.assertEqual(
            PAR.parse('143-63-20-17=13'),
            [Trait(value=13, units_inferred=True, is_shorthand=True,
                   start=0, end=15)])
    ...
    def test_parse_17(self):
        self.assertEqual(
            ...
            [Trait(value=22, units='g', is_shorthand=True, start=69, end=100)])
    ...
    def test_parse_19(self):
        self.assertEqual(
            PAR.parse(' {"gonadLengthInMM_1":"10", "gonadLengthInMM_2":"6", '
                      '"weight":"1,192.0" }'),
            [Trait(value=1192, units_inferred=True,
                   start=54, end=70)])

    def test_parse_20(self):
        self.assertEqual(
            PAR.parse('"weight: 20.5-31.8'),
            [Trait(value=[20.5, 31.8], units_inferred=True,
                   start=1, end=18)])

    def test_parse_21(self):
        self.assertEqual(
            PAR.parse('"weight: 20.5-32'),
            [Trait(value=[20.5, 32], units_inferred=True,
                   start=1, end=16)])
    ...
    def test_parse_23(self):
        self.assertEqual(
            ...
            [Trait(value=[21, 32], units_inferred=True,
                   start=1, end=14)])
    ...
    def test_parse_28(self):
        self.assertEqual(
            ...
            [Trait(value=995.06, ambiguous_key=True,
    ...
    def test_parse_29(self):
        self.assertEqual(
            ...
            [Trait(value=62, units='g', is_shorthand=True,
    ...
    def test_parse_31(self):
        self.assertEqual(
            ...
            [Trait(value=62, estimated_value=True, units_inferred=True,
    ...
    def test_parse_35(self):
        self.assertEqual(
            ...
            [Trait(value=50.8, units='g', estimated_value=True,
                   start=2, end=19)])
    ...
    def test_parse_38(self):
        self.assertEqual(
            ...
            [Trait(value=623.69, units='oz', start=2, end=14),
             Trait(value=623.69, units=['lbs', 'ozs'], start=25, end=39)])
    ...
    def test_parse_44(self):
        self.assertEqual(
            ...
            [Trait(value=10177.48, units=['lbs', 'ozs'], start=0, end=20)])
    ...
    def test_parse_46(self):
        self.assertEqual(
            ...
            [Trait(value=0.01, units='mgs', is_shorthand=True,
                   start=2, end=34)])
