...
class TestBodyMassTraitBuilder(unittest.TestCase):
    ...
    def test_parse_01(self):
        self.assertEqual(
            ...
            [Trait(
                value=2435, units='g', is_shorthand=True, start=0, end=22)])
    ...
    def test_parse_03(self):
        self.assertEqual(
            ...
            [Trait(
                value=62, units='g', is_shorthand=True, start=41, end=55)])
    ...
    def test_parse_08(self):
        self.assertEqual(
            ...
            [Trait(value=35, units='g', is_shorthand=True, start=8, end=36)])
    ...
    def test_parse_11(self):
        self.assertEqual(
            ...
            [Trait(value=41, units='g', is_shorthand=True, start=0, end=24)])
    ...
    def test_parse_13(self):
        self.assertEqual(
            ...
            [Trait(
                value=5.4, units_inferred=True, is_shorthand=True,
                start=12, end=39),
             Trait(value=5.4, units_inferred=True, start=41, end=51)])
    ...
    def test_parse_20(self):
        self.assertEqual(
            ...
            [Trait(value=[20.5, 31.8], units_inferred=True, start=1, end=18)])

    def test_parse_21(self):
        self.assertEqual(
            PAR.parse('"weight: 20.5-32'),
            [Trait(value=[20.5, 32], units_inferred=True, start=1, end=16)])
    ...
    def test_parse_23(self):
        self.assertEqual(
            ...
            [Trait(value=[21, 32], units_inferred=True, start=1, end=14)])
    ...
    def test_parse_29(self):
        self.assertEqual(
            ...
            [Trait(
                value=62, units='g', is_shorthand=True,
    ...
    def test_parse_31(self):
        self.assertEqual(
            ...
            [Trait(
                value=62, estimated_value=True, units_inferred=True,
    ...
    def test_parse_35(self):
        self.assertEqual(
            ...
            [Trait(
                value=50.8, units='g', estimated_value=True, start=2, end=19)])
    ...
    def test_parse_37(self):
        self.assertEqual(
            ...
            [Trait(value=650, units='kg', start=21, end=34)])

    def test_parse_38(self):
        self.assertEqual(
            PAR.parse('; weight=22 oz; Verbatim weight=1lb 6oz;'),
            [Trait(value=623.69, units='oz', start=2, end=14),
             Trait(
    ...
    def test_parse_45(self):
        self.assertEqual(
            ...
            [Trait(value=9979.03, units='lbs', start=23, end=39)])
