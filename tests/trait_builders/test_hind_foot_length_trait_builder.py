...
class TestHindFootLengthTraitBuilder(unittest.TestCase):
    ...
    parser = HindFootLengthTraitBuilder()

    def test_parse_01(self):
        self.assertEqual(
            self.parser.parse('hind foot with claw=30 mm;'),
            [NumericTrait(
    ...
    def test_parse_07(self):
        self.assertEqual(
            self.parser.parse('T: 98.5, HF: 29 ;'),
            [NumericTrait(
                value=29, units=None, units_inferred=True, start=9, end=15)])

    def test_parse_08(self):
        self.assertEqual(
            self.parser.parse('T-94mm, HF-30mm, E/n-19mm,'),
            [NumericTrait(
    ...
    def test_parse_12(self):
        self.assertEqual(
            self.parser.parse('"footLengthInMillimeters"="31",'),
            [NumericTrait(
    ...
    def test_parse_14(self):
        self.assertEqual(
            self.parser.parse('; hind foot with claw=2 in;'),
            [NumericTrait(
