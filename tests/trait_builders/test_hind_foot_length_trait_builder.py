...
class TestHindFootLengthTraitBuilder(unittest.TestCase):
    ...
    def test_parse_05(self):
        self.assertEqual(
            ...
            [Trait(value=31, units='mm_shorthand', is_shorthand=True,
                   start=2, end=33)])
    ...
    def test_parse_09(self):
        self.assertEqual(
            ...
            [Trait(value=30, units='mm_shorthand', is_shorthand=True,
                   start=2, end=26)])

    def test_parse_10(self):
        self.assertEqual(
            PAR.parse('measurements:210-92-30 308-190-45-20'),
            [Trait(value=45, units='mm_shorthand', is_shorthand=True,
                   start=23, end=36)])
    ...
    def test_parse_13(self):
        self.assertEqual(
            ...
            [Trait(value=37, units='mm_shorthand', is_shorthand=True,
                   start=2, end=34)])

    def test_parse_14(self):
        self.assertEqual(
            PAR.parse('; hind foot with claw=2 in;'),
            [Trait(value=50.8, units='in', includes='claw', start=2, end=26)])
