...
class TestTailLengthTraitBuilder(unittest.TestCase):
    ...
    def test_parse_03(self):
        self.assertEqual(
            ...
            [Trait(value=95, units_inferred=True, start=0, end=14)])

    def test_parse_04(self):
        self.assertEqual(
            PAR.parse(', "tail":"92", '),
            [Trait(value=92, units_inferred=True, start=3, end=12)])

    def test_parse_05(self):
        self.assertEqual(
            PAR.parse('"tailLengthInMillimeters"="104",'),
            [Trait(value=104, units='millimeters', start=1, end=30)])
    ...
    def test_parse_08(self):
        self.assertEqual(
            ...
            [Trait(value=95, units_inferred=True, start=0, end=13)])
    ...
    def test_parse_15(self):
        self.assertEqual(
            ...
            [Trait(value=85344, units='foot', start=29, end=45)])
