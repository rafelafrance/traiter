...
class TestTotalLengthTraitBuilder(unittest.TestCase):
    ...
    def test_parse_002(self):
        self.assertEqual(
            ...
            [Trait(value=230, units_inferred=True, start=14, end=21),
    ...
    def test_parse_009(self):
        self.assertEqual(
            PAR.parse((
                ...
                ' total length=231 mm; tail length=115 mm;')),
            [Trait(value=230, units_inferred=True, start=43, end=50),
    ...
    def test_parse_054(self):
        self.assertEqual(
            PAR.parse('SVL=44'),
            [Trait(value=44, units_inferred=True, start=0, end=6)])
    ...
    def test_parse_066(self):
        self.assertEqual(
            ...
            [Trait(value=5, units_inferred=True, start=0, end=18)])
    ...
    def test_parse_086(self):
        self.assertEqual(
            ...
            [Trait(value=141, units='mm', start=23, end=36)])
    ...
    def test_parse_088(self):
        self.assertEqual(
            ...
            [Trait(
                ...
                start=25, end=29),
             Trait(value=279.4, units='in', start=103, end=121)])
    ...
    def test_parse_093(self):
        self.assertEqual(
            ...
            [Trait(value=2164, units='cm', start=17, end=28)])

    def test_parse_094(self):
        self.assertEqual(
            PAR.parse('t.l.= 2 feet, 4.5 inches '),
            [Trait(value=723.9, units=['ft', 'in'], start=0, end=24)])
    ...
    def test_parse_099(self):
        self.assertEqual(
            ...
            [Trait(value=2250, units='cm', start=17, end=26)])
    ...
    def test_parse_100(self):
        self.assertEqual(
            PAR.parse(
                ...
                'HindFoot=470" }'),
            [Trait(value=1260, units_inferred=True, start=30, end=46)])
