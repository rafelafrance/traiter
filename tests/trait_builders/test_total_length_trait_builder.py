...
from traiter.trait_builders.total_length_trait_builder \
    import TotalLengthTraitBuilder
...
class TestTotalLengthTraitBuilder(unittest.TestCase):
    ...
    def test_parse_001(self):
        self.assertEqual(
            ...
            [NumericTrait(value=123, units='mm', start=2, end=23)])

    def test_parse_002(self):
        self.assertEqual(
            PAR.parse('measurements: ToL=230;TaL=115;HF=22;E=18;'
                      ' total length=231 mm; tail length=115 mm;'),
            [NumericTrait(value=230, units_inferred=True, start=14, end=21),
             NumericTrait(value=231, units='mm', start=42, end=61)])
    ...
    def test_parse_003(self):
        self.assertEqual(
            ...
            [NumericTrait(value=230, units_inferred=True, start=14, end=21),
             NumericTrait(value=240, units='cm', start=42, end=60)])
    ...
    def test_parse_006(self):
        self.assertEqual(
            ...
            [NumericTrait(
                value=308, units='mm_shorthand', is_shorthand=True,
                start=3, end=31)])
    ...
    def test_parse_008(self):
        self.assertEqual(
            ...
            [NumericTrait(value=54, units='mm', start=0, end=23),
             NumericTrait(value=111, units='mm', start=25, end=44)])
    ...
    def test_parse_009(self):
        self.assertEqual(
            PAR.parse((
                ...
                ' total length=231 mm; tail length=115 mm;')),
            [NumericTrait(value=230, units_inferred=True, start=43, end=50),
             NumericTrait(value=231, units='mm', start=71, end=90)])

    def test_parse_010(self):
        self.assertEqual(
            PAR.parse('143-63-20-17=13'),
            [NumericTrait(
                value=143, units='mm_shorthand', is_shorthand=True,
                start=0, end=15)])

    def test_parse_011(self):
        self.assertEqual(
            PAR.parse('** Body length =345 cm; Blubber=1 cm '),
            [NumericTrait(value=3450, units='cm', start=3, end=22)])
    ...
    def test_parse_014(self):
        self.assertEqual(
            ...
            [NumericTrait(value=609.6, units='ft', start=0, end=18)])

    def test_parse_015(self):
        self.assertEqual(
            PAR.parse('AJR-32   186-102-23-15  15.0g'),
            [NumericTrait(
                value=186, units='mm_shorthand', is_shorthand=True,
                start=9, end=29)])
    ...
    def test_parse_016(self):
        self.assertEqual(
            ...
            [NumericTrait(
                value=8, units='mm', ambiguous_key=True, start=0, end=11)])

    def test_parse_017(self):
        self.assertEqual(
            PAR.parse('another; length=8 mm'),
            [NumericTrait(
                value=8, units='mm', ambiguous_key=True, start=9, end=20)])

    def test_parse_018(self):
        self.assertEqual(
            PAR.parse('another; TL_120, noise'),
            [NumericTrait(
                value=120, units_inferred=True, start=9, end=15)])

    def test_parse_019(self):
        self.assertEqual(
            PAR.parse('another; TL - 101.3mm, noise'),
            [NumericTrait(value=101.3, units='mm', start=9, end=21)])

    def test_parse_020(self):
        self.assertEqual(
            PAR.parse('before; TL153, after'),
            [NumericTrait(
                value=153, units_inferred=True, start=8, end=13)])
    ...
    def test_parse_022(self):
        self.assertEqual(
            ...
            [NumericTrait(value=[16, 23], units='mm', start=7, end=48)])

    def test_parse_023(self):
        self.assertEqual(
            PAR.parse('Size=13 cm TL'),
            [NumericTrait(value=130, units='cm', start=5, end=13)])
    ...
    def test_parse_025(self):
        self.assertEqual(
            PAR.parse('SVL52mm'),
            [NumericTrait(value=52, units='mm', start=0, end=7)])

    def test_parse_026(self):
        self.assertEqual(
            PAR.parse('snout-vent length=221 mm; total length=257 mm; '
                      'tail length=36 mm'),
            [NumericTrait(value=221, units='mm', start=0, end=24),
             NumericTrait(value=257, units='mm', start=26, end=45)])

    def test_parse_027(self):
        self.assertEqual(
            PAR.parse('SVL 209 mm, total 272 mm, 4.4 g.'),
            [NumericTrait(value=209, units='mm', start=0, end=10),
             NumericTrait(value=272, units='mm', start=12, end=24)])

    def test_parse_028(self):
        self.assertEqual(
            PAR.parse('{"time collected":"0712-0900", "length":"12.0" }'),
            [NumericTrait(
                value=12, ambiguous_key=True, units_inferred=True,
                start=32, end=45)])
    ...
    def test_parse_029(self):
        self.assertEqual(
            ...
            [NumericTrait(
                value=[119, 137], ambiguous_key=True, units_inferred=True,
                start=109, end=125)])

    def test_parse_030(self):
        self.assertEqual(
            PAR.parse('TL (mm) 44,SL (mm) 38,Weight (g) 0.77 xx'),
            [NumericTrait(value=44, units='mm', start=0, end=10),
             NumericTrait(value=38, units='mm', start=11, end=21)])

    def test_parse_031(self):
        self.assertEqual(
            PAR.parse('{"totalLengthInMM":"270-165-18-22-31", '),
            [NumericTrait(
                value=270, units='mm_shorthand', is_shorthand=True,
                start=20, end=36)])
    ...
    def test_parse_032(self):
        self.assertEqual(
            ...
            [NumericTrait(
                value=[20, 29], ambiguous_key=True, units_inferred=True,
                start=2, end=16)])
    ...
    def test_parse_033(self):
        self.assertEqual(
            PAR.parse('field measurements on fresh dead specimen were '
                      '157-60-20-19-21g'),
            [NumericTrait(
                value=157, units='mm_shorthand', is_shorthand=True,
                start=47, end=63)])

    def test_parse_034(self):
        self.assertEqual(
            PAR.parse('f age class: adult; standard length: 63-107mm'),
            [NumericTrait(value=[63, 107], units='mm', start=20, end=45)])
    ...
    def test_parse_041(self):
        self.assertEqual(
            ...
            [NumericTrait(value=[20, 28], units='mm', start=0, end=10)])

    def test_parse_042(self):
        self.assertEqual(
            PAR.parse('29mm SL'),
            [NumericTrait(value=29, units='mm', start=0, end=7)])

    def test_parse_043(self):
        self.assertEqual(
            PAR.parse('{"measurements":"159-?-22-16=21.0" }'),
            [NumericTrait(
                value=159, units='mm_shorthand', is_shorthand=True,
                start=2, end=33)])
    ...
    def test_parse_045(self):
        self.assertEqual(
            ...
            [NumericTrait(
                value=21, units_inferred=True, start=0, end=13)])

    def test_parse_046(self):
        self.assertEqual(
            PAR.parse('Meas: L: 21.0 cm'),
            [NumericTrait(value=210, units='cm', start=0, end=16)])

    def test_parse_047(self):
        self.assertEqual(
            PAR.parse('LABEL. LENGTH 375 MM.'),
            [NumericTrait(value=375, units='mm', start=0, end=20)])

    def test_parse_048(self):
        self.assertEqual(
            PAR.parse('SL=12mm'),
            [NumericTrait(value=12, units='mm', start=0, end=7)])

    def test_parse_049(self):
        self.assertEqual(
            PAR.parse('Size=SL 12-14 mm'),
            [NumericTrait(value=[12, 14], units='mm', start=5, end=16)])
    ...
    def test_parse_051(self):
        self.assertEqual(
            ...
            [NumericTrait(value=123, units='mm', start=1, end=18)])

    def test_parse_052(self):
        self.assertEqual(
            PAR.parse(' Length: 12-34 mmSL'),
            [NumericTrait(value=[12, 34], units='mm', start=1, end=19)])

    def test_parse_053(self):
        self.assertEqual(
            PAR.parse('Measurements: L: 21.0 cm'),
            [NumericTrait(value=210, units='cm', start=0, end=24)])

    def test_parse_054(self):
        self.assertEqual(
            PAR.parse('SVL=44'),
            [NumericTrait(value=44, units_inferred=True, start=0, end=6)])

    def test_parse_055(self):
        self.assertEqual(
            PAR.parse('SVL=0 g'),
            [NumericTrait(
                value=0, units_inferred=True, start=0, end=5)])

    def test_parse_056(self):
        self.assertEqual(
            PAR.parse('SVL=44'),
            [NumericTrait(
                value=44, units_inferred=True, start=0, end=6)])

    def test_parse_057(self):
        self.assertEqual(
            PAR.parse('TL=50'),
            [NumericTrait(
                value=50, units_inferred=True, start=0, end=5)])

    def test_parse_058(self):
        self.assertEqual(
            PAR.parse('SVL=44mm'),
            [NumericTrait(value=44, units='mm', start=0, end=8)])
    ...
    def test_parse_062(self):
        self.assertEqual(
            ...
            [NumericTrait(value=760, units='cm', start=0, end=10)])
    ...
    def test_parse_064(self):
        self.assertEqual(
            ...
            [NumericTrait(
                value=970, units_inferred=True, start=2, end=19)])

    def test_parse_065(self):
        self.assertEqual(
            PAR.parse('LENGTH: 117MM. SOFT PARTS COLOR ON LABEL.'),
            [NumericTrait(
                value=117, units='mm', ambiguous_key=True, start=0, end=13)])

    def test_parse_066(self):
        self.assertEqual(
            PAR.parse('Meas:Length (L): 5'),
            [NumericTrait(value=5, units_inferred=True, start=0, end=18)])

    def test_parse_067(self):
        self.assertEqual(
            PAR.parse('Size=41-148mm SL'),
            [NumericTrait(value=[41, 148], units='mm', start=5, end=16)])

    def test_parse_068(self):
        self.assertEqual(
            PAR.parse('Size=105 mm TL, 87.1 mm PCL'),
            [NumericTrait(value=105, units='mm', start=5, end=14)])

    def test_parse_069(self):
        self.assertEqual(
            PAR.parse('Total Length: 185-252 mm'),
            [NumericTrait(value=[185, 252], units='mm', start=0, end=24)])

    def test_parse_070(self):
        self.assertEqual(
            PAR.parse('Total Length: 185 - 252 mm'),
            [NumericTrait(value=[185, 252], units='mm', start=0, end=26)])

    def test_parse_071(self):
        self.assertEqual(
            PAR.parse('"bottom":"rock?", "length":"278" }'),
            [NumericTrait(
                value=278, ambiguous_key=True, units_inferred=True,
                start=19, end=31)])
    ...
    def test_parse_073(self):
        self.assertEqual(
            ...
            [NumericTrait(
                value=308, units='mm_shorthand', is_shorthand=True,
                estimated_value=True, start=3, end=33)])
    ...
    def test_parse_077(self):
        self.assertEqual(
            ...
            [NumericTrait(
                value=210, units='mm_shorthand', is_shorthand=True,
                start=2, end=26)])
    ...
    def test_parse_079(self):
        self.assertEqual(
            ...
            [NumericTrait(value=[185, 252], units='mm', start=0, end=33)])
    ...
    def test_parse_081(self):
        self.assertEqual(
            ...
            [NumericTrait(
                value=9.52, ambiguous_key=True, units='in', start=0, end=13)])

    def test_parse_082(self):
        self.assertEqual(
            PAR.parse('LENGTH 0 3/8 IN. WING CHORD 5.25 IN. TAIL 4.25 IN.'),
            [NumericTrait(
                value=9.52, ambiguous_key=True, units='in', start=0, end=15)])

    def test_parse_083(self):
        self.assertEqual(
            PAR.parse('unformatted measurements=42-51 mm SL'),
            [NumericTrait(value=[42, 51], units='mm', start=12, end=33)])
    ...
    def test_parse_086(self):
        self.assertEqual(
            ...
            [NumericTrait(value=141, units='mm', start=23, end=36)])

    def test_parse_087(self):
        self.assertEqual(
            PAR.parse('L: 275. T: 65.; '),
            [NumericTrait(
                value=275, units_inferred=True, ambiguous_key=True,
                start=0, end=6)])
    ...
    def test_parse_088(self):
        self.assertEqual(
            PAR.parse('unformatted measurements=L-11&#34;, T-3.125&#34;, '
                      ...
                      '4/12/39 . | 1.5 TRUE'),
            [NumericTrait(
                value=11, units_inferred=True, ambiguous_key=True,
                start=25, end=29),
             NumericTrait(value=279.4, units='in', start=103, end=121)])
    ...
    def test_parse_093(self):
        self.assertEqual(
            ...
            [NumericTrait(value=2164, units='cm', start=17, end=28)])

    def test_parse_094(self):
        self.assertEqual(
            PAR.parse('t.l.= 2 feet, 4.5 inches '),
            [NumericTrait(value=723.9, units=['ft', 'in'], start=0, end=24)])
    ...
    def test_parse_099(self):
        self.assertEqual(
            ...
            [NumericTrait(value=2250, units='cm', start=17, end=26)])
    ...
    def test_parse_100(self):
        self.assertEqual(
            PAR.parse(
                ...
                'HindFoot=470" }'),
            [NumericTrait(value=1260, units_inferred=True, start=30, end=46)])
    ...
    def test_parse_102(self):
        self.assertEqual(
            PAR.parse(
                ...
                'HindFoot=400" }'),
            [NumericTrait(
                value=1487.5, units_inferred=True, start=30, end=48)])
    ...
    def test_parse_103(self):
        self.assertEqual(
            ...
            [NumericTrait(
                value=522, units='mm', ambiguous_key=True, start=72, end=87)])
