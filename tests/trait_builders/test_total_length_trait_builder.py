...
class TestTotalLengthTraitBuilder(unittest.TestCase):
    ...
    def test_parse_011(self):
        self.assertEqual(
            ...
            [NumericTrait(
                value=3450, units='cm', units_inferred=False, start=3, end=22)])

    def test_parse_012(self):
        self.assertEqual(
            PAR.parse('t.l.= 2 feet 3.1 - 4.5 inches '),
            [NumericTrait(
                value=[688.34, 723.9], units=['ft', 'in'], units_inferred=False,
                start=0, end=29)])
    ...
    def test_parse_030(self):
        self.assertEqual(
            ...
            [NumericTrait(
             ...
             NumericTrait(
                 value=38, units='mm', units_inferred=False, start=11, end=21)])
    ...
    def test_parse_086(self):
        self.assertEqual(
            ...
            [NumericTrait(
                value=141, units='mm', units_inferred=False, start=23, end=36)])
    ...
    def test_parse_100(self):
        self.assertEqual(
            PAR.parse(
                ...
                'HindFoot=470" }'),
            [NumericTrait(
                value=1260, units=None, units_inferred=True, start=30, end=46)])
