...
class TestTotalLengthTraitBuilder(unittest.TestCase):
    ...
    def test_parse_006(self):
        self.assertEqual(
            ...
            [Trait(value=308, units='mm_shorthand', is_shorthand=True,
                   start=3, end=31)])
    ...
    def test_parse_010(self):
        self.assertEqual(
            ...
            [Trait(value=143, units='mm_shorthand', is_shorthand=True,
                   start=0, end=15)])
    ...
    def test_parse_013(self):
        self.assertEqual(
            ...
            [Trait(value=[688.34, 723.9], ambiguous_key=True,
    ...
    def test_parse_015(self):
        self.assertEqual(
            ...
            [Trait(value=186, units='mm_shorthand', is_shorthand=True,
                   start=9, end=29)])

    def test_parse_016(self):
        self.assertEqual(
            PAR.parse('length=8 mm'),
            [Trait(value=8, units='mm', ambiguous_key=True,
                   start=0, end=11)])
    ...
    def test_parse_018(self):
        self.assertEqual(
            ...
            [Trait(value=120, units_inferred=True,
                   start=9, end=15)])
    ...
    def test_parse_020(self):
        self.assertEqual(
            ...
            [Trait(value=153, units_inferred=True,
                   start=8, end=13)])
    ...
    def test_parse_028(self):
        self.assertEqual(
            ...
            [Trait(value=12, ambiguous_key=True, units_inferred=True,
                   start=32, end=45)])
    ...
    def test_parse_029(self):
        self.assertEqual(
            ...
            [Trait(value=[119, 137], ambiguous_key=True, units_inferred=True,
                   start=109, end=125)])
    ...
    def test_parse_031(self):
        self.assertEqual(
            ...
            [Trait(value=270, units='mm_shorthand', is_shorthand=True,
                   start=20, end=36)])

    def test_parse_032(self):
        self.assertEqual(
            PAR.parse('{"length":"20-29" }'),
            [Trait(value=[20, 29], ambiguous_key=True, units_inferred=True,
                   start=2, end=16)])
    ...
    def test_parse_033(self):
        self.assertEqual(
            PAR.parse('field measurements on fresh dead specimen were '
                      '157-60-20-19-21g'),
            [Trait(value=157, units='mm_shorthand', is_shorthand=True,
                   start=47, end=63)])
    ...
    def test_parse_043(self):
        self.assertEqual(
            ...
            [Trait(value=159, units='mm_shorthand', is_shorthand=True,
                   start=2, end=33)])
    ...
    def test_parse_045(self):
        self.assertEqual(
            ...
            [Trait(value=21, units_inferred=True,
                   start=0, end=13)])
    ...
    def test_parse_055(self):
        self.assertEqual(
            PAR.parse('SVL=0 g'),
            [Trait(value=0, units_inferred=True,
                   start=0, end=5)])

    def test_parse_056(self):
        self.assertEqual(
            PAR.parse('SVL=44'),
            [Trait(value=44, units_inferred=True,
                   start=0, end=6)])

    def test_parse_057(self):
        self.assertEqual(
            PAR.parse('TL=50'),
            [Trait(value=50, units_inferred=True,
                   start=0, end=5)])
    ...
    def test_parse_071(self):
        self.assertEqual(
            ...
            [Trait(value=278, ambiguous_key=True, units_inferred=True,
                   start=19, end=31)])
    ...
    def test_parse_077(self):
        self.assertEqual(
            ...
            [Trait(value=210, units='mm_shorthand', is_shorthand=True,
                   start=2, end=26)])
    ...
    def test_parse_081(self):
        self.assertEqual(
            ...
            [Trait(value=9.52, ambiguous_key=True, units='in',
                   start=0, end=13)])
    ...
    def test_parse_087(self):
        self.assertEqual(
            ...
            [Trait(value=275, units_inferred=True, ambiguous_key=True,
                   start=0, end=6)])
    ...
    def test_parse_088(self):
        self.assertEqual(
            PAR.parse('unformatted measurements=L-11&#34;, T-3.125&#34;, '
                      ...
                      '4/12/39 . | 1.5 TRUE'),
            [Trait(value=11, units_inferred=True, ambiguous_key=True,
                   start=25, end=29),
    ...
    def test_parse_102(self):
        self.assertEqual(
            PAR.parse(
                ...
                'HindFoot=400" }'),
            [Trait(value=1487.5, units_inferred=True, start=30, end=48)])
    ...
    def test_parse_103(self):
        self.assertEqual(
            ...
            [Trait(value=522, units='mm', ambiguous_key=True,
                   start=72, end=87)])
    ...
    def test_parse_106(self):
        self.assertEqual(
            ...
            [Trait(value=212, units='mm_shorthand', is_shorthand=True,
                   start=16, end=33)])
