...
class TestSharedPlant(unittest.TestCase):
    ...
    def test_range_01(self):
        actual = scan([SCANNER['range']], '123')
        expect = [Token(SCANNER['range'], span=(0, 3),
                        groups={'range': '123', 'low': '123'})]
        self.assertEqual(actual, expect)

    def test_range_02(self):
        actual = scan([SCANNER['range']], '123-45')
        expect = [Token(
            SCANNER['range'], span=(0, 6),
            groups={'range': '123-45', 'low': '123', 'high': '45'})]
        self.assertEqual(actual, expect)

    def test_range_03(self):
        actual = scan([SCANNER['range']], '(12-)23-34(-45)')
        expect = [Token(
            SCANNER['range'], span=(0, 15),
            groups={'range': '(12-)23-34(-45)', 'low': '23', 'high': '34',
                    'min': '12', 'max': '45'})]
        self.assertEqual(actual, expect)

    def test_range_04(self):
        actual = scan([SCANNER['range']], '23-34(-45)')
        expect = [Token(
            SCANNER['range'], span=(0, 10),
            groups={'range': '23-34(-45)', 'low': '23', 'high': '34',
                    'max': '45'})]
        self.assertEqual(actual, expect)

    def test_range_05(self):
        actual = scan([SCANNER['range']], '(12-)23-34')
        expect = [Token(
            SCANNER['range'], span=(0, 10),
    ...
    def test_cross_01(self):
        actual = scan([SCANNER['cross']], '(12-)23-34')
        expect = [Token(
            SCANNER['cross'], span=(0, 10),
    ...
    def test_cross_02(self):
        actual = scan([SCANNER['cross']], '(12-)23-34 × 45-56')
        expect = [Token(
            SCANNER['cross'], span=(0, 18),
    ...
    def test_upper_only_01(self):
        actual = scan([SCANNER['cross_upper']], 'to 10 cm')
        expect = [Token(
            SCANNER['cross_upper'], span=(0, 8),
