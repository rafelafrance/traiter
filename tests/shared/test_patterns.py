...
class TestSharedPatterns(unittest.TestCase):
    ...
    def test_range_02(self):
        ...
        expect = [Token(
            ...
            groups={'number': ['12.3', '45.6'], 'range_joiner': '-',
                    'range': '12.3-45.6'})]
        self.assertEqual(actual, expect)
    ...
    def test_cross_01(self):
        parser = Parser(
            scanners=[SCANNER['number'], SCANNER['cross_joiner']],
            replacers=[REPLACER['cross']])
        actual = parser.parse('12x34')
        expect = [Token(
            rule=REPLACER['cross'], span=(0, 5),
            groups={'number': ['12', '34'], 'cross_joiner': 'x',
                    'cross': '12x34'})]
        self.assertEqual(actual, expect)
    ...
    def test_cross_02(self):
        ...
        expect = [Token(
            ...
            groups={'number': ['12.3', '45.6'], 'cross_joiner': 'by',
                    'cross': '12.3 by 45.6'})]
        self.assertEqual(actual, expect)
    ...
    def test_cross_03(self):
        ...
        expect = [
            ...
            Token(
                ...
                groups={'number': ['12.3', '45.6'], 'cross_joiner': 'x',
                        'cross': '12.3 x 45.6'}),
            Token(SCANNER['number'], span=(14, 15), groups={'number': '8'})]
        self.assertEqual(actual, expect)
