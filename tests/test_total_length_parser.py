...
class TestTotalLengthParser(unittest.TestCase):
    ...
    def test_search_and_normalize_12(self):
        self.assertDictEqual(
            ...
            {'has_length': True,
             'length_in_mm': None,
             'length_units_inferred': 0,
             'length_type': 'total length range'})
    ...
    def test_search_and_normalize_22(self):
        self.assertDictEqual(
            ...
            {'has_length': True,
             'length_in_mm': None,
             'length_units_inferred': None,
             'length_type': 'snout-vent length range'})
    ...
    def test_search_and_normalize_34(self):
        self.assertDictEqual(
            ...
            {'has_length': True,
             'length_in_mm': None,
             'length_units_inferred': None,
             'length_type': 'standard length range'})
    ...
    def test_search_and_normalize71(self):
        # This one is a trawl measurement of some kind,
        # not an organism measurement
        self.assertDictEqual(
            TARGET.search_and_normalize(
