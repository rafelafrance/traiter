...
from lib.trait_builders.embryo_count_trait_builder import \
    EmbryoCountTraitBuilder
from lib.trait_builders.embryo_length_trait_builder import \
    EmbryoLengthTraitBuilder
from lib.trait_builders.hind_foot_length_trait_builder import \
    HindFootLengthTraitBuilder
from lib.trait_builders.lactation_state_trait_builder import \
    LactationStateTraitBuilder
from lib.trait_builders.life_stage_trait_builder import \
    LifeStageTraitBuilder
from lib.trait_builders.nipple_count_trait_builder import \
    NippleCountTraitBuilder
from lib.trait_builders.nipple_state_trait_builder import  \
...
from lib.trait_builders.placental_scar_count_trait_builder import \
    PlacentalScarCountTraitBuilder
from lib.trait_builders.pregnancy_state_trait_builder import \
    PregnancyStateTraitBuilder
from lib.trait_builders.sex_trait_builder import \
    SexTraitBuilder
