...
#
# from traiter.patterns_ import PatternMatcherType
#
#
# @Language.factory('match_to_entity')
# def match_to_entity(nlp: Language, name: str, patterns: PatternMatcherType):
#     """Create a pipe that uses a standard spacy matcher but filters the results."""
#     return MatchToEntity(nlp, patterns)
#
#
# class MatchToEntity:
#     """A matchers that converts matches to entities."""
#
