...
from pylib.parsers.numeric import fix_up_inches, fraction, compound, simple
from pylib.parsers.numeric import shorthand_length
...
TOTAL_LENGTH = Base(
    ...
    scanners=[
        ...
        SHARED['shorthand'],
        SHARED['triple'],  # Truncated shorthand
